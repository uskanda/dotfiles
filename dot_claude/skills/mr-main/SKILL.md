---
name: mr-main
description: developブランチからmainブランチへのマージリクエスト(GitLab)／プルリクエスト(GitHub)を作成してください。
allowed-tools: Bash
---

# developからmainへのマージリクエスト / プルリクエスト作成

`develop` ブランチから `main` ブランチへのマージリクエスト（GitLab）または
